  ...
  return (
    <section aria-labelledby="home-hero-title" className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex flex-col items-center px-6 pt-28 pb-2 text-center sm:min-h-[min(88vh,780px)] sm:justify-center sm:px-10 sm:pt-24 sm:pb-36">
          <h1
            id="home-hero-title"
        ...
        <div className="relative -mt-16 px-6 pb-20 sm:-mt-28 sm:px-10 sm:pb-24 lg:px-12">
