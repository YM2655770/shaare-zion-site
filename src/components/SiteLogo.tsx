    ...
    >
      <Image
        ...
        className={cn(
          ...
          isHero
            ? "max-h-[120px] max-w-[min(300px,72vw)] object-center drop-shadow-[0_2px_14px_rgba(0,0,0,0.4)] sm:max-h-28 sm:max-w-[300px] sm:object-left lg:max-h-32 lg:max-w-[340px]"
